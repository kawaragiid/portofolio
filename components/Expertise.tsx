...
export default function Expertise() {
  ...
  // Mengunci scroll pada layar utama saat popup terbuka
  useEffect(() => {
    if (selectedId) {
      ...
      {mounted && createPortal(
        <AnimatePresence>
          {selectedId && selectedItem && (
            <div className="fixed inset-0 z-[999999] flex items-center justify-center px-4 md:px-10 py-6 md:py-10 pointer-events-auto">
              ...
              {/* Kertas Halaman Detail - LIQUID GLASS TETAP TERJAGA */}
              <motion.div
