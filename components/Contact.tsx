...
export default function Contact() {
  ...
  // Fungsi untuk menangani pengiriman pesan via mailto
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    // Membuka aplikasi email bawaan user dengan draf otomatis
    ...
    <section id="contact" className="relative max-w-5xl mx-auto px-6 py-24 z-10">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-gray-400 text-lg max-w-xl mx-auto">
          Silakan hubungi saya untuk proyek penyuntingan video, pembuatan subtitle, atau peluang kerja sama lainnya.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* CARD 1: FORMULIR KONTAK LANGSUNG (Menggantikan Discord & mengambil ruang besar) */}
            ...
            <form onSubmit={handleSendMessage} className="space-y-4">
              ...
              <div>
                ...
                <textarea 
                  rows={4}
                  required
                  placeholder="tulis pesan atau penawaran proyekmu di sini..." 
                  value={message}
        ...
        <div className="bg-white/[0.02] backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col justify-center items-center text-center shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
          ...
          <p className="text-xs text-gray-500 mt-2">Available for Remote Work</p>
        </div>
        ...
        {/* CARD 4: UPWORK (Menggunakan Link Profil Aslimu) */}
        <a 
          href={upworkLink}
          target="_blank" 
        ...
        >
          ...
          <p className="text-gray-400 text-sm font-semibold tracking-widest uppercase mb-1">Freelance Profile</p>
